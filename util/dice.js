...
function init(rollType, players, gameName, msg) {
    console.log(players);
    // if (rollType === "p") {
    //     db.init(players, true, false, gameName, msg, result => {
            
    //     });
    // } else if (rollType === "e") {
    //     db.init(players, false, true);
    // } else {
    //     db.init(players, false, false, gameName, msg, result => {
    //         console.log(result);
    //     });
    // }
}
